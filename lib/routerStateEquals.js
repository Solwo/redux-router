...
function routerStateEquals(a, b) {
  ...
  return a.location.pathname === b.location.pathname && a.location.search === b.location.search && a.location.hash === b.location.hash && (0, _deepEqual2.default)(a.location.state, b.location.state);
}